...
# Date: 2023-12-31 15:00 UTC - 2024-09-16 20:00 UTC - last change
...
DESCRIPTION="random - print a pseudo-random number. Useful in shell scripts"
HOMEPAGE="http://acme.com/software/random/"
...
PV="20140814"
XPV="14Aug2014"
SRC_URI="http://acme.com/software/${PN}/${PN}_14Aug2014.tar.gz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="+static -doc (-musl) +diet +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  mkdir -pm 0755 "${ED}/bin/" "${ED}/usr/share/man/man1/"
