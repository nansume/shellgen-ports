...
# http://data.gpo.zugaina.org/gentoo/media-sound/musepack-tools/musepack-tools-495.ebuild
...
PV="495"
SRC_URI="
  https://dev.gentoo.org/~sam/distfiles/${CATEGORY}/${PN}/${PN}-${PV}.tar.xz
  http://data.gpo.zugaina.org/gentoo/media-sound/musepack-tools/files/${PN}-${PV}-respect-cflags.patch
  http://data.gpo.zugaina.org/gentoo/media-sound/musepack-tools/files/${PN}-${PV}-fixup-link-depends.patch
  http://data.gpo.zugaina.org/gentoo/media-sound/musepack-tools/files/${PN}-${PV}-incompatible-pointers.patch
"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  patch -p1 -E < "${FILESDIR}"/${PN}-${PV}-respect-cflags.patch
  patch -p1 -E < "${FILESDIR}"/${PN}-${PV}-fixup-link-depends.patch
  patch -p1 -E < "${FILESDIR}"/${PN}-${PV}-incompatible-pointers.patch
