...
# Date: 2025-02-28 12:00 UTC - last change
# Build with useflag: +static +static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/media-sound/mpg123/mpg123-1.32.3.ebuild
...
PV="1.29.3"
PV="1.32.3"
SRC_URI="ftp://mirrors.tera-byte.com/pub/gentoo/distfiles/${PN}-${PV}.tar.bz2"
