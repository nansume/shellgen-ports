...
# Date: 2025-05-24 07:00 UTC - last change
...
use 'bootstrap' || {
  if pkg-is "sys-devel/gcc14"; then
    pkginst "sys-devel/gcc14"
  elif pkg-is "sys-devel/gcc10"; then
...
if pkg-is "dev-build/libtool14"; then
  pkginst "dev-build/libtool14"
