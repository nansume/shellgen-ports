...
# Usage [for bootstrap]: USE='+bootstrap +x32' emerge -b -- sys-devel/flex
...
SRC_URI="
  https://ftp.fau.de/gentoo/distfiles/${PN}-${PV}.tar.gz
...
ZCOMP='gunzip'
IUSE="-bootstrap -rpath -nls +static-libs +static -test +strip"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  rm -vr -- "usr/share/man" "usr/share/info" "usr/share/doc"
