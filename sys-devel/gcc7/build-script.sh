...
SRC_URI="
  ...
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/01_all_default-fortify-source.patch
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/07_all_libiberty-asprintf.patch
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/09_all_nopie-all-flags.patch
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/13_all_respect-build-cxxflags.patch
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/15_all_libgomp-Werror.patch
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/16_all_libitm-Werror.patch
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/17_all_libatomic-Werror.patch
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/18_all_libbacktrace-Werror.patch
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/19_all_libsanitizer-libbacktrace-Werror.patch
  https://gitweb.gentoo.org/proj/gcc-patches.git/plain/${PV}/gentoo/20_all_libstdcxx-no-vtv.patch
"
USE_BUILD_ROOT="0"
...
use 'bootstrap' || {
  if pkg-is "sys-devel/gcc7" > /dev/null; then
    pkginst "sys-devel/gcc7"
  elif pkg-is "sys-devel/gcc8" > /dev/null; then
...
if pkg-is "dev-build/libtool7" > /dev/null; then
  pkginst "dev-build/libtool7"
elif pkg-is "dev-build/libtool8" > /dev/null; then
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  #pkg-is "sys-devel/gcc7" > /dev/null || append-cxxflags -fpermissive
