...
# Date: 2025-06-11 19:00 UTC - last change
...
use 'bootstrap' || {
  ...
  if pkg-is "sys-devel/binutils6" > /dev/null; then
    pkginst "sys-devel/binutils6"
  elif pkg-is "sys-devel/binutils9" > /dev/null; then
