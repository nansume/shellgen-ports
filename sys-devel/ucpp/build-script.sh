...
# Date: 2024-09-12 19:00 UTC, 2025-05-23 21:00 UTC - last change
# Build with useflag: +static +static-libs -shared -lfs +nopie +patch -doc -xstub -diet +musl +stest +strip +x32

# BUG: build with flags: +static +static-libs +shared - build without shared lib*.so
# TODO: +static +static-libs +shared
...
PV="1.3.3"
PV="1.3.5"
SRC_URI="http://dev.gentooexperimental.org/~scarabeus/${PN}-${PV}.tar.xz"
SRC_URI="rsync://mirror.bytemark.co.uk/gentoo/distfiles/*/${PN}-${PV}.tar.xz"
SRC_URI="https://mirrors.mit.edu/macports/distfiles/ucpp/${PN}-${PV}.tar.bz2"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  use 'stest' && { bin/${PN} -v || : die "binary work... error";}  # prog ver return error
