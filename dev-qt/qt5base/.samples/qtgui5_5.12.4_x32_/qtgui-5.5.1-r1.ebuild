...
SRC_URI="http://master.qt.io/archive/qt/${PV%\.*}/${PV}/submodules/${QT5_MODULE}-opensource-src-${PV}.tar.xz"
...
IUSE="accessibility dbus directfb egl eglfs evdev +gif gles2 gtkstyle
