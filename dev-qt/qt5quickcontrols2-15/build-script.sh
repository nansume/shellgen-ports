...
# http://data.gpo.zugaina.org/gentoo/dev-qt/qtquickcontrols2/qtquickcontrols2-5.15.17.ebuild
...
XPN=${XPN:-$PN}
PN=${PN%[0-9]*}
SPN1="qtquickcontrols2-everywhere-opensource-src"
SPN2="qtquickcontrols2-everywhere-src"
PV="5.15.17"
