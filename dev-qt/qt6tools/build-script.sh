...
# http://data.gpo.zugaina.org/gentoo/dev-qt/qttools/qttools-6.9.0.ebuild
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="+assistant -clang -designer -distancefieldgenerator -gles2-only +linguist"
IUSE="${IUSE} -opengl -pixeltool +qdbus -qdoc -qml -qmlls -qtattributionsscanner -qtdiag"
IUSE="${IUSE} -qtplugininfo -vulkan +widgets -zstd"
