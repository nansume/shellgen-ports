...
# http://data.gpo.zugaina.org/gentoo/dev-qt/qtwebchannel/qtwebchannel-5.15.16.ebuild
...
XPN=${XPN:-$PN}
PN=${PN%[0-9]*}
SPN="qtwebchannel-everywhere-opensource-src"
PV="5.15.16"
...
BUILD_DIR="${PDIR%/}/${SRC_DIR}/qtwebchannel-everywhere-src-${PV}"
PWD=${PWD%/}; PWD=${PWD:-/}
LIB_DIR=$(get_libdir)
LIBDIR="/${LIB_DIR}"
PKG_CONFIG="pkgconf"
