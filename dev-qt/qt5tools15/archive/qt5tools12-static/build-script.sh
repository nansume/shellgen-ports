...
# Date: 2025-05-17 12:00 UTC - last change
# Build with useflag: +static +static-libs -shared -ssl +glib -python -doc -xstub +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/dev-qt/qttools/qttools-6.8.2.ebuild
...
pkginst \
  ...
  "dev-qt/qt5base12-static" \
  "dev-qt/qt5declarative12-static" \
  "dev-util/gperf" \
  "dev-util/pkgconf" \
  "media-libs/alsa-lib" \
