...
# http://data.gpo.zugaina.org/gentoo/dev-qt/qtgraphicaleffects/qtgraphicaleffects-5.15.17.ebuild
...
XPN=${XPN:-$PN}
PN=${PN%[0-9]*}
SPN1="qtgraphicaleffects-everywhere-opensource-src"
SPN2="qtgraphicaleffects-everywhere-src"
PV="5.15.17"
