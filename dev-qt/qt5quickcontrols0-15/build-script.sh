...
# http://data.gpo.zugaina.org/gentoo/dev-qt/qtquickcontrols/qtquickcontrols-5.15.17.ebuild
...
XPN=${XPN:-$PN}
PN=${PN%[0-9]*}
SPN1="qtquickcontrols-everywhere-opensource-src"
SPN2="qtquickcontrols-everywhere-src"
PV="5.15.17"
