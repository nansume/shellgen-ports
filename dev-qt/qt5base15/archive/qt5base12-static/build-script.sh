...
# Date: 2025-05-17 08:00 UTC - last change
# Build with useflag: -static-libs +shared +ssl +glib -doc -xstub +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/dev-qt/qtcore/qtcore-5.15.16.ebuild
# http://data.gpo.zugaina.org/gentoo/eclass/qt5-build.eclass
# https://crux.nu/ports/crux-3.7/opt/qt5/Pkgfile

# base-modules: Qt5Accessibility Qt5Concurrent Qt5Core Qt5DBus Qt5Gui Qt5Network
# base-modules: t5OpenGL Qt5Sql Qt5Widgets Qt5Xml
