...
# Date: 2024-03-25 01:00 UTC - last change
# Date: 2024-10-12 17:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs +nopie +patch -doc -xstub -diet +musl +stest +strip +x32

# https://gitweb.gentoo.org/repo/gentoo.git/plain/dev-lang/ruby/ruby-2.6.10.ebuild?id=${COMMIT}
...
COMMIT="f246f6813abb1463274b9eace59895babce14a83"
SRC_URI="https://gitweb.gentoo.org/repo/gentoo.git/plain/dev-lang/ruby/files/2.6"
SRC_URI="
