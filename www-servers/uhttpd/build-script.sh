...
# Date: 2024-11-08 16:00 UTC - last change
...
XPN=${XPN:-$PN}
PV="2023-06-25"
HASH="34a8a74dbdec3c0de38abc1b08f6a73c51263792"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-ssl -lua -ubus -ucode -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
pkginst \
  ...
  "dev-libs/json-c  # static build - BUG: needed static-libs, BUG: ld: cannot find -ljson_script" \
  "dev-libs/libubox" \
  "dev-util/cmake" \
  "dev-util/pkgconf" \
  "sys-devel/binutils" \
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  cmake \
    ...
    -DUCODE_SUPPORT=$(usex 'ucode' ON OFF) \
