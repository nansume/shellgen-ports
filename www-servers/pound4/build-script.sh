...
# Date: 2025-07-22 19:00 UTC - last change
# Build with useflag: +static -static-libs -shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/www-servers/pound/pound-4.16.ebuild
...
PN=${PN%[0-9]}
PV="4.16"
SRC_URI="https://github.com/graygnuorg/pound/releases/download/v${PV}/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  rm -v -r -- "bin/${PN}ctl" "bin/"
  rm -v -r -- "usr/share/${PN}/" "usr/"
