...
# Date: 2025-05-18 12:00 UTC - last change
...
PV="1.9.0"
SRC_URI="
  https://github.com/LubosD/${PN}/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="+alsa -g729 +speex +zrtp +qt4 -qt5 -static +shared -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ln -s linux-g++ /usr/share/qt4/mkspecs/default
fi
