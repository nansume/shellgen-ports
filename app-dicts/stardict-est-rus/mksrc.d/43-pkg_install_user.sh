...
DESCRIPTION="Stardict Dictionary Estonian-Russian"
HOMEPAGE="https://sourceforge.net/projects/xdxf/files/"
LICENSE="GPL-2"  # Really? Required verify! TODO: unclean with license, then remove it.
LICENSE=""  # Now not found license! Drop it!
IUSE="-gzip"
