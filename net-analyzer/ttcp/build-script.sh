...
# Date: 2024-02-27 18:00 UTC - last change
...
HOMEPAGE="https://ftp.arl.mil/~mike/ttcp.html"
SRC_URI="http://www.netcore.fi/pekkas/linux/ipv6/${PN}.c"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="+static (-diet) (+ipv6) (+musl) +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  $(usex diet 'diet -Os gcc -nostdinc' "gcc$(usex static ' -static --static')" ) \
  ${CFLAGS} ${LDFLAGS} ${PN}.c -o ${PN}
