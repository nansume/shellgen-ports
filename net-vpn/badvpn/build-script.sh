...
# Date: 2024-08-28 17:00 UTC - last change
...
DESCRIPTION="NCD scripting language, tun2socks proxifier, P2P VPN"
DESCRIPTION="Alternative for <sockstun>"
...
PV="1.999.130"
PV="2021.08.22"
SRC_URI="https://github.com/ambrop72/badvpn/archive/1.999.130.tar.gz"
SRC_URI="https://github.com/ambrop72/badvpn/archive/master.tar.gz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
pkginst \
  "#dev-libs/lwip  # is bundled, no need" \
  "dev-util/cmake" \
