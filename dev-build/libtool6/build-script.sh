...
# Date: 2025-05-24 14:00 UTC - last change
# Build with useflag: +static +static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# Usage [for bootstrap]: USE=`+bootstrap +x32` emerge -b -- sys-devel/libtool

# http://data.gpo.zugaina.org/gentoo/dev-build/libtool/libtool-2.5.4.ebuild
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-bootstrap +static-libs +static +shared -vanilla -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
use 'bootstrap' || pkginst "sys-devel/gcc6"
