...
PN=${PN%[0-9]}
PV="2.5.1"
SRC_URI="https://github.com/SCons/scons/archive/2.5.1.tar.gz -> scons-src-2.5.1.tar.gz"
...
pkginst \
  ...
  "dev-libs/expat" \
  "dev-libs/libffi" \
  "dev-libs/openssl-compat  # required for <stest> [optional]" \
  "dev-python/py2-setuptools" \
  "sys-devel/make" \
  "sys-libs/musl" \
  "sys-libs/zlib  # required for <stest> [optional]" \
