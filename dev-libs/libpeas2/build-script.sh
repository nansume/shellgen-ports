...
# http://data.gpo.zugaina.org/gentoo/dev-libs/libpeas/libpeas-2.0.3.ebuild
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-glade -gtk-doc -javascript -lua -python -vala -static-libs +shared -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  meson setup \
    ...
    -Dbuildtype="release" \
    -Dgjs=$(usex 'javascript' true false) \
