...
# Date: 2025-05-24 11:00 UTC - last change
# Build with useflag: -static +static-libs +shared -lfs +nopie +patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/dev-libs/isl/isl-0.27.ebuild
...
PV="0.27"
SRC_URI="
  https://libisl.sourceforge.io/${PN}-${PV}.tar.xz
  http://data.gpo.zugaina.org/gentoo/dev-libs/isl/files/isl-0.24-gdb-autoload-dir.patch
  http://data.gpo.zugaina.org/gentoo/dev-libs/isl/files/isl-0.24-respect-flags.patch
"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  patch -p1 -E < "${FILESDIR}"/${PN}-0.24-gdb-autoload-dir.patch
  patch -p1 -E < "${FILESDIR}"/${PN}-0.24-respect-flags.patch
