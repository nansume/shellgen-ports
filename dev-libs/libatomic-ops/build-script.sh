...
# http://data.gpo.zugaina.org/gentoo/dev-libs/libatomic_ops/libatomic_ops-7.8.2.ebuild
...
PN=${PN/-/_}
PV="7.8.2"
SRC_URI="https://github.com/ivmai/libatomic_ops/releases/download/v${PV}/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  : libtoolize  # BUG: error: ./ltmain.sh is newer: use --force to overwrite
