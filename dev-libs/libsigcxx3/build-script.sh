...
PN="libsigc++"
PV="3.6.0"
SRC_URI="https://download.gnome.org/sources/libsigc++/${PV%.*}/libsigc++-${PV}.tar.xz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-gtk-doc -test -nls -rpath -static-libs +shared -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  sed \
    ...
    -i $(get_libdir)/pkgconfig/${PN#lib}*.pc || : die
