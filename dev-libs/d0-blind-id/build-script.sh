...
# Date: 2024-11-13 16:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs +nopie +patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/dev-libs/d0_blind_id/d0_blind_id-1.0_p20201124.ebuild
...
PV="1.0_p20201124"
XPV=${PV/_}
HASH="c32ee93edd10288ca40e1eb81263f0a37309b32c"  # xonotic-0.8.5
SRC_URI="https://gitlab.com/xonotic/d0_blind_id/-/archive/${HASH}/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
