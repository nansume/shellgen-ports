...
# Date: 2024-09-14 17:00 UTC - last change
...
PN=${PN%[0-9]}
PV="0.12.2"
SRC_URI="http://deb.debian.org/debian/pool/main/libb/${PN}/${PN}_${PV}.orig.tar.xz -> ${PN}-${PV}.tar.xz"
USE_BUILD_ROOT="0"
...
pkginst \
  "app-crypt/libmd  # the musl libc without MD5 functions." \
  "sys-apps/file" \
  "sys-devel/binutils" \
  "sys-devel/gcc" \
  "sys-devel/make" \
