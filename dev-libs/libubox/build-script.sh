...
# Date: 2024-11-08 13:00 UTC - last change
...
XPN=${XPN:-$PN}
PV="2024.03.29"
HASH="eb9bcb64185ac155c02cc1a604692c4b00368324"
SRC_URI="https://git.openwrt.org/?p=project/${PN}.git"
SRC_URI="${SRC_URI};a=snapshot;h=${HASH};sf=tgz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
BUILD_DIR="${PDIR%/}/${SRC_DIR}/${PN}-${HASH%${HASH#???????}}"
PWD=${PWD%/}; PWD=${PWD:-/}
LIB_DIR=$(get_libdir)
LIBDIR="/${LIB_DIR}"
PKG_CONFIG="pkgconf"
