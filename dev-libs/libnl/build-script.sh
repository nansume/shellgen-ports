...
# Date: 2024-11-10 11:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/dev-libs/libnl/libnl-3.10.0.ebuild
...
PV="3_11_0"
XPV=${PV/_/.}
SRC_URI="https://github.com/thom311/libnl/archive/${PN}${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-debug -python -test +utils -static -static-libs +shared -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
pkginst \
  ...
  "sys-devel/binutils" \
  "sys-devel/bison  # POSIX Yacc does not support" \
  "sys-devel/flex  # POSIX Lex does not support" \
  "sys-devel/gcc9" \
