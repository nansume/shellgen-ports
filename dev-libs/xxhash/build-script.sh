...
# Date: 2025-05-29 08:00 UTC - last change
# Build with useflag: -static +static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/dev-libs/xxhash/xxhash-0.8.3.ebuild
...
SPN="xxHash"
PV="0.8.3"
SRC_URI="https://github.com/Cyan4973/xxHash/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  use strip && strip --verbose --strip-all "bin/${PROG}" "$(get_libdir)/"lib${PN}.so.${PV}
