...
# TODO: to configure (he is into source)

# http://data.gpo.zugaina.org/gentoo/dev-libs/libevdev/libevdev-1.13.4.ebuild
...
XPN=${XPN:-$PN}
PV="1.13.4"
SRC_URI="https://www.freedesktop.org/software/libevdev/${PN}-${PV}.tar.xz"
USE_BUILD_ROOT="0"
