...
# Date: 2024-07-09 15:00 UTC - last change
...
XPN=${XPN:-$PN}
PV="6.9.9"
SRC_URI="https://github.com/kkos/${PN}/releases/download/v${PV}/onig-${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
USER=${USER:-root}
USE_BUILD_ROOT="0"
...
BUILD_DIR="${PDIR%/}/${SRC_DIR}/onig-${PV}"
WORKDIR=${BUILD_DIR}
PWD=${PWD%/}; PWD=${PWD:-/}
LIB_DIR=$(get_libdir)
LIBDIR="/${LIB_DIR}"
