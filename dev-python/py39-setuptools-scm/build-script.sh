...
# https://crux.nu/ports/crux-3.8/contrib/python3-setuptools-scm/Pkgfile
...
SPN="setuptools_scm"
PV="8.3.1"
SRC_URI="https://files.pythonhosted.org/packages/source/s/setuptools_scm/${SPN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
