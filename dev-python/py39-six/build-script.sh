...
# Date: 2025-06-06 22:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs -nopie +patch -doc -xstub -diet +musl +stest +strip +x32

# Compatible with python-3.12

# https://crux.nu/ports/crux-3.8/opt/python3-six/Pkgfile
...
PN=${PN#py3[0-9]-}
PV="1.17.0"
SRC_URI="https://files.pythonhosted.org/packages/source/s/six/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
