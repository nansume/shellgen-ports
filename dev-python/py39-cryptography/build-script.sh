...
# Date: 2025-06-06 21:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs -nopie +patch -doc -xstub -diet +musl +stest +strip +x32

# Compatible with python-3.12

# https://crux.nu/ports/crux-3.8/contrib/python3-cryptography/Pkgfile
...
XPN=${XPN:-$PN}
PN=${PN#py3[0-9]-}
PV="45.0.3"  # BUG: required rust, go to hell!
PV="3.3"     # BUG: required rust, go to hell!
PV="3.2.1"   # FIX: install without rust
SRC_URI="https://files.pythonhosted.org/packages/source/c/cryptography/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
