...
# https://crux.nu/ports/crux-3.8/contrib/python3-pycryptodome/Pkgfile
...
HOMEPAGE="https://github.com/Legrandin/pycryptodome/ https://pypi.org/project/pycryptodomex/"
...
PN=${PN#py3[0-9]-}
PV="3.23.0"
SRC_URI="https://github.com/Legrandin/pycryptodome/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
