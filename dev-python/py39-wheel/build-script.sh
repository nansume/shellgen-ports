...
# https://crux.nu/ports/crux-3.8/opt/python3-wheel/Pkgfile
...
PN=${PN#py3[0-9]-}
PV="0.46.1"
SRC_URI="https://files.pythonhosted.org/packages/source/w/wheel/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  python3 -m build --wheel --skip-dependency-check --no-isolation || exit
  ...
  #find "${ED}/" -name README.txt -delete
