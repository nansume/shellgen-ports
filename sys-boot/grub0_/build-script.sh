...
# Date: 2025-02-09 12:00 UTC - last change
...
# https://raw.githubusercontent.com/archlinux/svntogit-packages/packages/grub/trunk/PKGBUILD
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  if use 'fonts'; then
    ...
    ln -s "/usr/share/fonts/X11/unifont.pcf" . || die
  fi
