...
# Date: 2024-09-08 11:00 UTC - last change
...
PN="musl-rpmatch"
PV="1.0"
SRC_URI="https://github.com/pullmoll/musl-rpmatch/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  mv -n musl-rpmatch.pc "${ED}"/$(get_libdir)/pkgconfig/${XPN}.pc
  ...
  sed \
    ...
    -i $(get_libdir)/pkgconfig/${XPN}.pc || die
