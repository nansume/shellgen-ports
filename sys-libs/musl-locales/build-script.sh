...
# Date: 2024-11-10 13:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# https://git.alpinelinux.org/aports/plain/main/musl-locales/APKBUILD
...
PV="0.1.0"
SRC_URI="
  https://git.adelielinux.org/adelie/${PN}/-/archive/${PV}/${PN}-${PV}.tar.bz2
  https://git.alpinelinux.org/aports/plain/main/${PN}/add-all-available-locales.patch
"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  patch -p1 -E < "${FILESDIR}"/add-all-available-locales.patch
  ...
  use 'stest' && { bin/${PROG} -m || die "binary work... error";}
