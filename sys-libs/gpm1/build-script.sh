...
PN=${PN%[0-9]}
PV="1.20.7"
PV="1.20.8"  # 1.20.7p20200617
SPV="1.20.7p20200617"
SRC_URI="
  https://github.com/telmich/gpm/archive/master.tar.gz -> ${PN}-${SPV}.tar.gz
  #https://www.nico.schottelius.org/software/${PN}/archives/${PN}-${PV}.tar.lzma
  https://repo.iut.ac.ir/repo/gentoo-portage/${CATEGORY}/${PN}/files/${PN}-1.20.7-sysmacros.patch
  https://repo.iut.ac.ir/repo/gentoo-portage/${CATEGORY}/${PN}/files/${PN}-1.20.7-glibc-2.26.patch
  http://data.gpo.zugaina.org/gentoo/sys-libs/gpm/files/gpm-1.20.7-gcc-10.patch
  http://data.gpo.zugaina.org/gentoo/${CATEGORY}/${PN}/files/${PN}-1.20.7-musl.patch
  http://data.gpo.zugaina.org/gentoo/${CATEGORY}/${PN}/files/${PN}-1.20.7-gcc-include.patch
  http://data.gpo.zugaina.org/gentoo/${CATEGORY}/${PN}/files/${PN}-1.20.7-signedness.patch
  http://deb.debian.org/debian/pool/main/g/${PN}/${PN}_1.20.7-11.debian.tar.xz
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  if use 'static'; then
    ...
    PF=${pf} ZCOMP="unlzma" ZCOMP="gunzip"
