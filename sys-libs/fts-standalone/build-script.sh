...
# Date: 2024-03-28 18:00 UTC - last change
...
SRC_URI="https://github.com/pullmoll/${XPN}/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
LICENSE="BSD"
USER=${USER:-root}
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="+static-libs +shared (+musl) -doc +stest (-test) +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
