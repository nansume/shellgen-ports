...
# Date: 2023-12-31 15:00 UTC - last change
...
PV="20140814"
XPV="14Aug2014"
DESCRIPTION="micro_proxy - really small HTTP/HTTPS proxy"
HOMEPAGE="http://acme.com/software/micro_proxy/"
SRC_URI="http://acme.com/software/${XPN}/${XPN}_14Aug2014.tar.gz"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="+static (-ssl) (+musl) -diet +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
# bug with flag build: <+diet> - dns resolv func - no work
if use 'diet'; then
