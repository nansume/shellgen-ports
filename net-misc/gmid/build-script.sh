...
# Date: 2025-05-02 20:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/guru/net-misc/gmid/gmid-2.1.1.ebuild
...
XPN=${XPN:-$PN}
PV="2.1.1"
SRC_URI="https://ftp.omarpolo.com/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-seccomp -test -static +shared -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
