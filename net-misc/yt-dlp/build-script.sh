...
# http://data.gpo.zugaina.org/gentoo/net-misc/yt-dlp/yt-dlp-2025.05.22.ebuild
...
PN=${PN#py3[0-9]-}
PV="2025.05.22"
SRC_URI="https://github.com/yt-dlp/${PN}/archive/${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
