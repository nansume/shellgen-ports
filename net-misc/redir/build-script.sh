...
# Date: 2024-03-10 21:00 UTC - last change
# Build with useflag: +static -ftp +shaper -diet +musl +x32
...
IUSE="${IUSE} -ftp -shaper -tcpd +xinetd +inetd -compat"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
