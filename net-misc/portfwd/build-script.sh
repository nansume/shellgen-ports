...
# Date: 2025-04-13 21:00 UTC - last change
# Build with useflag: +static -static-libs -shared -lfs +nopie +patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/net-misc/portfwd/portfwd-0.29-r2.ebuild
...
SRC_URI="
  ...
  http://data.gpo.zugaina.org/gentoo/net-misc/portfwd/files/portfwd-0.29-build-system.patch
"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  patch -p1 -E < "${FILESDIR}"/${PN}-0.29-build-system.patch
