...
# Date: 2024-09-16 15:00 UTC - last change
...
XPN=${XPN:-$PN}
PV="0.5.1"
SRC_URI="https://github.com/projg2/${PN}/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="libnotify +shared -doc (+musl) +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
pkginst \
  ...
  use 'libnotify' && pkginst "x11-libs/libtinynotify"
