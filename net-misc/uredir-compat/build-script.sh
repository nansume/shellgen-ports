...
# Date: 2024-03-11 14:00 UTC - last change
...
PN=${PN%-*}
PV="2.0"
DESCRIPTION="UDP port redirector (old)"
HOMEPAGE="https://github.com/troglobit/uredir"
SRC_URI="ftp://ftp.troglobit.com/${PN}/${PN}-${PV}.tar.gz"
LICENSE="ISC"
USER=${USER:-root}
USE_BUILD_ROOT="0"
...
PN="${PN}-compat" INST_ABI="$(tc-abi-build)" pkg-create-cgz
