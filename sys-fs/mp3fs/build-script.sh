...
# Date: 2025-03-16 20:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/sys-fs/mp3fs/mp3fs-1.1.1-r5.ebuild
...
XPN=${XPN:-$PN}
PV="1.1.1"
SRC_URI="https://github.com/khenriks/mp3fs/releases/download/v${PV}/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="+flac -vorbis -static +shared -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
