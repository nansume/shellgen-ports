...
# Date: 2024-09-18 15:00 UTC - last change
...
PV="4.0.44"
PROG="bin/${PN}"
SRC_URI="mirror://gnu/${PN}/${PN}-${PV}.tar.lz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-gui +static -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  # Default is fine
  : sed -e '/^SAMPLE FILE$/s:^:#:' -i etc/mtools/mtools.conf || die
