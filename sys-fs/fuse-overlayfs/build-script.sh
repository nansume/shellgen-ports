...
# https://git.alpinelinux.org/aports/plain/community/fuse-overlayfs/APKBUILD
# http://data.gpo.zugaina.org/gentoo/sys-fs/fuse-overlayfs/fuse-overlayfs-1.14.ebuild
...
XPN=${XPN:-$PN}
PV="1.14"
SRC_URI="https://github.com/containers/fuse-overlayfs/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
