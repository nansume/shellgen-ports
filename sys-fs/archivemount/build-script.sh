...
# Date: 2025-03-16 17:00 UTC - last change
# Build with useflag: +static -static-libs -shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# https://git.alpinelinux.org/aports/plain/community/archivemount/APKBUILD
# http://data.gpo.zugaina.org/gentoo/sys-fs/archivemount/archivemount-0.9.1.ebuild
...
HOMEPAGE="https://github.com/bramp/archivemount"
...
XPN=${XPN:-$PN}
PV="0.9.1"
SRC_URI="http://www.cybernoia.de/software/archivemount/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  test -x "/bin/perl" && autoreconf -fis
