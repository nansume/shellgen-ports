...
# Date: 2025-03-15 19:00 UTC - last change
# Build with useflag: +static -static-libs -shared -lfs +nopie -patch -doc -xstub +diet -musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/net-libs/rpcsvc-proto/rpcsvc-proto-1.4.4.ebuild
# https://git.alpinelinux.org/aports/plain/main/rpcsvc-proto/APKBUILD
...
XPN=${XPN:-$PN}
PV="1.4.4"
SRC_URI="https://github.com/thkukuk/rpcsvc-proto/releases/download/v${PV}/${PN}-${PV}.tar.xz"
USE_BUILD_ROOT="0"
...
pkginst \
  ...
  "sys-devel/gcc9" \
  "sys-devel/make" \
  "sys-libs/musl0  # needed for diet - bug configure" \
