...
# Date: 2024-11-26 18:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/net-libs/nghttp2/nghttp2-1.64.0.ebuild
...
XPN=${XPN:-$PN}
PV="1.64.0"
SRC_URI="https://github.com/nghttp2/nghttp2/releases/download/v${PV}/${PN}-${PV}.tar.xz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-debug -hpack-tools -jemalloc -static-libs -systemd -test -utils +xml +shared -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
