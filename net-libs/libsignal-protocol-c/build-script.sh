...
# Date: 2024-08-13 13:00 UTC - last change
...
XPN=${XPN:-$PN}
PV="2.3.3"
BASE_URI="data.gpo.zugaina.org/gentoo/net-libs/libsignal-protocol-c/files"
SRC_URI="
  https://github.com/signalapp/${PN}/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz
  https://${BASE_URI}/libsignal-protocol-c-2.3.3-CVE-2022-48468.patch
"
USE_BUILD_ROOT="0"
...
pkginst \
  "dev-util/cmake" \
  "dev-util/ninja  # required for cmake" \
  "dev-util/pkgconf  # required for cmake" \
  "sys-devel/binutils" \
  "sys-devel/gcc" \
  "sys-devel/make" \
  "sys-libs/musl" \
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  patch -p1 -E < "${FILESDIR}"/${PN}-2.3.3-CVE-2022-48468.patch
  ...
  cmake \
    ...
    -DLIB_INSTALL_DIR="${EPREFIX%/}/$(get_libdir)" \
