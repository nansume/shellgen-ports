...
# Date: 2025-02-23 19:00 UTC - last change
...
XPN=${XPN:-$PN}
PV="1.8"
SRC_URI="https://github.com/mananapr/cfiles/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  sed -e 's/$(CC) $(CFLAGS)/& $(LDFLAGS)/g' -i Makefile || die
