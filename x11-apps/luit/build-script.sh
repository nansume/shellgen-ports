...
# Date: 2025-03-17 16:00 UTC - last change
# Build with useflag: +static -static-libs -shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/x11-apps/luit/luit-20240910.ebuild
...
XPN=${XPN:-$PN}
PV="20240910"
SRC_URI="https://invisible-mirror.net/archives/${PN}/${PN}-${PV}.tgz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
