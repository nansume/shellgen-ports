...
# Date: 2024-11-11 18:00 UTC - last change
# Build with useflag: -static -static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/net-irc/weechat/weechat-4.4.2-r100.ebuild
...
XPN=${XPN:-$PN}
PV="4.4.2"
SRC_URI="https://weechat.org/files/src/${PN}-${PV}.tar.xz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-doc -enchant -man -nls -relay-api -selinux -test -zstd +irc +alias +buflist +charset"
IUSE="${IUSE} +exec +fifo +fset +logger +relay +scripts -spell +trigger +typing"
IUSE="${IUSE} +xfer -guile -lua -perl -python -ruby -tcl +ja +ru"
