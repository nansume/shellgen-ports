...
# Date: 2024-09-16 17:00 UTC - last change
...
DESCRIPTION="unrar-free is a free software version of the non-free unrar utility."
...
RV="1"
SRC_URI="
  http://deb.debian.org/debian/pool/main/u/unrar-free/unrar-free_${PV}.orig.tar.xz -> unrar-free-${PV}.tar.xz
  http://deb.debian.org/debian/pool/main/u/unrar-free/unrar-free_${PV}-${RV}.debian.tar.xz
"
USE_BUILD_ROOT="0"
