...
# Date: 2025-04-04 17:00 UTC - last change
# Build with useflag: static +static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/nest/dev-cpp/belr/belr-5.3.1.ebuild
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-test +tools -static-libs +shared -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
