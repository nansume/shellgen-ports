...
# http://data.gpo.zugaina.org/gentoo/dev-cpp/ms-gsl/ms-gsl-4.1.0.ebuild
...
PV="4.1.0"
SRC_URI="
  https://github.com/Microsoft/GSL/archive/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz
  http://data.gpo.zugaina.org/gentoo/dev-cpp/ms-gsl/files/ms-gsl-1.0.0-disable_Werror-644042.patch
"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  gpatch -p1 -E < "${FILESDIR}/${PN}-1.0.0-disable_Werror-644042.patch"
