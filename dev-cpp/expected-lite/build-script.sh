...
# http://data.gpo.zugaina.org/gentoo/dev-cpp/expected-lite/expected-lite-0.8.0.ebuild
...
XPN=${XPN:-$PN}
PV="0.8.0"
SRC_URI="https://github.com/martinmoene/expected-lite/archive/refs/tags/v${PV}.tar.gz -> ${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  cmake -B build -G "Unix Makefiles" \
    ...
    -D EXPECTED_LITE_OPT_BUILD_TESTS=$(usex 'test' ON OFF) \
    -Wno-dev \
