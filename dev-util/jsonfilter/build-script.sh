...
# Homepage: https://git.openwrt.org/project/jsonpath.git
# License: ISC
# Depends: libubox libjson-c
# Date: 2026-02-01 20:00 UTC - last change
# Build with useflag: +static -static-libs -shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# https://github.com/openwrt/openwrt/archive/master.tar.gz  package/utils/jsonfilter/Makefile
...
XPN=${XPN:-$PN}
PV="2025.10.04"
HASH="f4fe702d0e8d9f8704b42f5d5c10950470ada231"  # 2025.10.04
SRC_URI="https://github.com/openwrt/${SPN}/archive/${HASH}.tar.gz -> ${SPN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
BUILD_DIR="${PDIR%/}/${SRC_DIR}/${SPN}-${HASH}"
PWD=${PWD%/}; PWD=${PWD:-/}
LIB_DIR=$(get_libdir)
LIBDIR="/${LIB_DIR}"
PKG_CONFIG="pkgconf"
