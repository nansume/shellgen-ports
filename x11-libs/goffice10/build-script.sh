...
# Date: 2024-07-31 14:00 UTC - last change
...
PV="0.10.17"
SRC_URI="
  https://download.gnome.org/sources/goffice/0.10/goffice-0.10.17.tar.xz
  #https://download.gnome.org/sources/goffice/0.9/goffice-0.9.1.tar.xz
...
pkginst \
  ...
  "x11-libs/libxcomposite  # deps for gtk2" \
