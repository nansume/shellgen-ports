...
# Date: 2025-04-02 21:00 UTC - last change
# Build with useflag: -static +static-libs +shared -lfs +nopie -patch -doc -xstub -diet +musl +stest +strip +x32

# http://data.gpo.zugaina.org/gentoo/media-libs/sdl-gfx/sdl-gfx-2.0.26-r2.ebuild
...
PN=${XPN/sdl-/SDL_}
PV="2.0.26"
SLOT="16"  # libSDL_gfx.so.16
SRC_URI="https://www.ferzkopp.net/Software/SDL_gfx-2.0/${PN}-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
BUILD_USER="tools"
SRC_DIR="build"
IUSE="-doc +cpu_flags_x86_mmx +mmx +static-libs +shared -doc (+musl) +stest +strip"
EABI=$(tc-abi-build)
ABI=${EABI}
XABI=${EABI}
SPREFIX="/"
