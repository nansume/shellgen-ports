...
# http://data.gpo.zugaina.org/gentoo/media-libs/faad2/faad2-2.11.1.ebuild
...
PV="2.11.1"
SRC_URI="
  https://github.com/knik0/faad2/archive/${PV}.tar.gz -> ${PN}-${PV}.tar.gz
  http://data.gpo.zugaina.org/gentoo/media-libs/faad2/files/faad2-2.11.0-check-if-lrintf-is-defined.patch
"
USE_BUILD_ROOT="0"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  gpatch -p1 -E < "${FILESDIR}/faad2-2.11.0-check-if-lrintf-is-defined.patch"
  ...
  sed -e 's|${prefix}|/usr|' -i $(get_libdir)/pkgconfig/${PN}.pc || : die
