...
# Date: 2024-08-14 20:00 UTC - last change
...
TAG="62dcb00e"  # Ver: 1.34
TAG="a2335604"  # Ver: 1.38 (1.37.*)
PV="2.19"  # build ok.
PV="2.24"  # build ok.
PV="2.25"  # build ok.
PV="1.34"  # build ok.
...
SRC_URI="https://fossil-scm.org/home/tarball/${TAG}/fossil-src-${PV}.tar.gz"
SRC_URI="https://fossil-scm.org/home/tarball/fossil-src-2.25.tar.gz"  # last release version
SRC_URI="https://fossil-scm.org/home/tarball/${PV}/fossil-src.tar.gz -> fossil-src-${PV}.tar.gz"  # same?
SRC_URI="https://fossil-scm.org/home/tarball/${TAG}/fossil-src-${PV}.tar.gz"
USE_BUILD_ROOT="0"
...
BUILD_DIR="${PDIR%/}/${SRC_DIR}/Fossil-${TAG}"  # ver: 1.34
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  #use 'static' && sed -i -e "s| -lpthread||" Makefile
