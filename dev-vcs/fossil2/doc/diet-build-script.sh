...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  CC="cc -static --static"
  DIET="diet" CC="diet -Os gcc -nostdinc" CPP="diet -Os gcc -E -nostdinc" CXX="diet -Os gcc -nostdinc"
  ...
  ./configure \
    ...
    --host=$(tc-chost | sed 's/dietlibc/musl/') \
    --build=$(tc-chost | sed 's/dietlibc/musl/') \
