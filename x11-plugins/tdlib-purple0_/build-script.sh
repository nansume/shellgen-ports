...
# tdlib-1.8.4 -> commit 7eabd8ca60de025e45e99d4e5edd39f4ebd9467e
# [PATCH]: gnu: tdlib: Update to 1.8.4
# https://issues.guix.gnu.org/57017
# https://issues.guix.gnu.org/search?query=tdlib
...
XPN=${XPN:-$PN}
PN=${PN%[0-9]*}
PV="20230929"  # compat 1.8.4
#PV="0.8.20"
#PV="0.8.10"
TDLIB="tdlib-1.8.4.tar.xz"
SRC_URI="
