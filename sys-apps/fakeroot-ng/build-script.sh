...
PV="0.18"
PV="0.17"
HASH="972b022a10cdeb0f61052982002f42b4-194791-1246280321"
SRC_URI="
  https://src.rrz.uni-hamburg.de/object/${HASH}/fakeroot-ng-${PV}.tar.gz  # v0.17
  #https://downloads.sourceforge.net/project/fakerootng/fakeroot-ng/${PV}/fakeroot-ng-${PV}.tar.gz
  #http://deb.debian.org/debian/pool/main/f/fakeroot-ng/fakeroot-ng_${PV}.orig.tar.gz
  http://deb.debian.org/debian/pool/main/f/fakeroot-ng/fakeroot-ng_0.18-4.1.debian.tar.xz
  http://localhost/pub/distfiles/patch/fakeroot-ng-${PV}-musl-fixes.patch  # v0.17
"
USE_BUILD_ROOT="0"
