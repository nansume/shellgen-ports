...
# Date: 2023-11-23 15:00 UTC - last change
# Date: 2024-12-27 16:00 UTC - last change
...
BUILD_USER='tools'
SRC_DIR='build'
IUSE="+static -shared -doc +tftp +dhcp -regex (+musl) +stest +strip"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  src-patch "${DISTSOURCE}/${PN}-${PV}-p001-regex-server.diff"
