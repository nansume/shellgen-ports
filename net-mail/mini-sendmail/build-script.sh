...
XPN="mini_sendmail"
PV="1.3.9"
DESCRIPTION="mini_sendmail - accept email on behalf of real sendmail"
HOMEPAGE="http://acme.com/software/mini_sendmail/"
...
if { test "X${USER}" = 'Xroot' && test "${BUILD_CHROOT:=0}" -ne '0' ;} ;then
  ...
  use 'strip' && strip --verbose --strip-all "${ED}/sbin/${XPN}"
